defmodule HexDocsSearchWeb.PackageLiveTest do
  ...
  @create_attrs %{
    ...
    search_items_json: %{},
    sidebar_items_json: %{},
    last_pulled: "2023-07-06T17:59:00Z"
  }
  @update_attrs %{
    meta: %{},
    name: "some updated name",
    docs_html_url: "some updated docs_html_url",
    downloads_all: 43,
    downloads_day: 43,
    downloads_recent: 43,
    downloads_week: 43,
    latest_docs_url: "some updated latest_docs_url",
    html_url: "some updated html_url",
    latest_stable_version: "some updated latest_stable_version",
    search_items_json: %{},
    sidebar_items_json: %{},
    last_pulled: "2023-07-07T17:59:00Z"
  }
  @invalid_attrs %{
    meta: nil,
    name: nil,
    ...
    downloads_all: nil,
    downloads_day: nil,
    downloads_recent: nil,
    downloads_week: nil,
    latest_docs_url: nil,
    html_url: nil,
    latest_stable_version: nil,
    search_items_json: nil,
    sidebar_items_json: nil,
    last_pulled: nil
  }
